...
- _Development Version 0.13.3_: 
    - __Update__: ETM v4: Support for Q Elements
    - __Update__: ETM v4: Support for speculative execution trace packets.
    - __Update__: Output Elements: Additional Information on _UNSYNC & _EOT elements. 
    - __Update__: ETM v4: Rework of decoder. Reduce re-enterant complexity. Buffer output elements till input packet decode complete.
